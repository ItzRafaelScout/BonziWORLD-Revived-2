...
let lastUser = "";
const sfx = {
    explode: new Audio("https://bonzl.world/sfx/explode.wav"),
};
...
function bonzilog(id, name, html, color, text, single) {
        ...
        chat_log_content.insertAdjacentHTML("beforeend", `
            ...
            <div class="log_message">
                ...
                <div class="log_message_cont">
                    <div class="reply"></div>
                    <span><b>${name}</b> ${name ? timeString : ""}</span>
    ...
    chat_log_content.lastChild.querySelector(".reply").onclick = () => {
        ...
        talkcard.innerHTML = `Replying to ${name}`;
        chat_message.focus();
...
function loadBonzis(a) {
    loadQueue.loadManifest([
        ...
        { id: "mametchi", src: "./img/bonzi/mametchi.gif" },
        { id: "topjej", src: "./img/misc/topjej.png" },
	{ id: "gold", src: "./img/misc/gold.gif" },
        { id: "redstone", src: "./img/misc/redstone.gif" },
	{ id: "quartz", src: "./img/misc/quartz.gif" },
	{ id: "rainbowsaber", src: "./img/misc/rainbowsaber.gif" },
	{ id: "nostalgic", src: "./img/misc/nostalgic.gif" },
	{ id: "iron", src: "./img/misc/iron.gif" },
	{ id: "emerald", src: "./img/misc/emerald.gif" },
	{ id: "nethergold", src: "./img/misc/nethergold.gif" },
	{ id: "diamond", src: "./img/misc/diamond.gif" },
	{ id: "glitch_jitter", src: "./img/misc/glitch_jitter.gif" },
	{ id: "nosurf", src: "./img/misc/nosurf.gif" },
	{ id: "purplesaber", src: "./img/misc/purplesaber.gif" },
	{ id: "coal", src: "./img/misc/coal.gif" },
...
function setup() {
    $("#chat_send").click(sendInput),
        ...
        socket.on("room", function (a, p) {
            ...
            if (a.room == "watch") {
                document.getElementById("news").innerHTML = '<video style="position:absolute;overflow:hidden;width:100%;height:100%;pointer-events:none;top:0;left:0;" autoplay loop><source src="https://dn720702.ca.archive.org/0/items/tomandjerry_1080p/S1940E01%20-%20Puss%20Gets%20The%20Boot%20%281080p%20BluRay%20x265%20Ghost%29.mp4" type="video/mp4">Your browser does not support the video tag.</video>'
            }
            p.play();
        ...
        if (chance === 1) {
            audio = new Audio("https://bonzl.world/explode3.wav");
            audio.play();
        } else if (chance === 2) {
            audio = new Audio("https://bonzl.world/explode4.wav");
            audio.play();
        } else if (chance === 3) {
            audio = new Audio("https://bonzl.world/explode5.wav");
            audio.play();
        }
        if (debrischance === 1) {
            audio2 = new Audio("https://bonzl.world/debris1.wav");
            audio2.play();
        } else if (debrischance === 2) {
            audio2 = new Audio("https://bonzl.world/debris2.wav");
            audio2.play();
        } else if (debrischance === 3) {
            audio2 = new Audio("https://bonzl.world/debris3.wav");
            audio2.play();
        }
        b.explode();
        ...
        socket.on("leave", function (a) {
            var b = bonzis[a.guid];
            var msg = `${b.userPublic.name} has left.`;
            setTimeout(function () {
                if (b.color == "diogo") {
...
var _createClass = (function () {
            ...
            _createClass(a, [
                ...
                },
                {
                    ...
                    value: function (a, b, c) {
                        ...
                        bonzilog(this.id, this.userPublic.name, a, this.color, a, false);
                        ...
                        if (this.userPublic.color == "program") {
                            ...
                            speak.play(
                                b,
                                { pitch: this.userPublic.pitch, amplitude: this.userPublic.amplitude, speed: this.userPublic.speed },
                                function () {
                                    d.clearDialog();
                                },
                                function (a) {
	...
	if (this.color.startsWith("http")) {
                var d = { images: ["./img/bonzi/blank.png"], frames: BonziData.sprite.frames, animations: BonziData.sprite.animations }
    ...
    BonziData = {
        ...
        sprite: {
            mametchi: {        
                ...
                animations: {
		    idle: 0,
		    surf_intro: [100, 100, "idle", 0.5],
		    surf_away: [100, 100, "gone", 0.5],
		    gone: 100,
		    clap_fwd: [0, 3, "clap_still", 0.5],
		    clap_still: [3, 4, "clap_still", 0.5],
		    clap_back: { frames: range(3, 0), next: "idle", speed: 0.5 },
		    shrug_fwd: [54, 54, "shrug_still", 0.5],
		    shrug_still: 54,
		    shrug_back: { frames: range(54, 54), next: "idle", speed: 0.5 },
		    earth_fwd: [36, 36, "earth_still", 0.5],
		    earth_still: 36,
		    earth_back: { frames: range(36, 36), next: "idle", speed: 0.5 },
		    grin_fwd: [5, 5, "grin_still", 0.5],
		    grin_still: 5,
		    grin_back: { frames: range(5, 5), next: "idle", speed: 0.5 },
		}
	    },
	bonzi: {
        ...
        window.BonziHandler = new (function () {
            return (
				...
				"coal"
                        ...
                        var c = a[b];
			if (c == 'bonzi') {
			    d = { images: ["./img/bonzi/" + c + ".gif"], frames: BonziData.sprite.bonzi.frames, animations: BonziData.sprite.bonzi.animations };
		        } else if (c == 'peedy' || c == 'peedy_pope') {
                            ...
                            d = { images: ["./img/bonzi/" + c + ".gif"], frames: BonziData.sprite.mametchi.frames, animations: BonziData.sprite.mametchi.animations };
                        } else {
                ...
                (this.bonzisCheck = function () {
                    for (var a = 0; a < usersAmt; a++) {
                        var b = usersKeys[a];
                        if (b in bonzis) {
                            var msg = `${usersPublic[b].name} has joined.`;
